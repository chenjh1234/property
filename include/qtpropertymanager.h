...
protected:
    ...
    virtual void initializeProperty(QtProperty *property);
    virtual void uninitializeProperty(QtProperty *property);
    // Internal use only, do not call these function below
public:
    int indexFromValue(QtProperty *property, int value) const;
    int valueFromIndex(QtProperty *property, int index) const;
    int index(const QtProperty *property) const;
private:
...
class  QtPathPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
Q_SIGNALS:
    void valueChanged(QtProperty *property, const QString &val);
    void openPathTriggered(QtProperty *property, QtPathPropertyManager *thisManager);
protected:
    QString valueText(const QtProperty *property) const;
    virtual void initializeProperty(QtProperty *property);
    virtual void uninitializeProperty(QtProperty *property);
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void slotDeliverOpenPath(QtProperty*));
};

class  QtCustomPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    QtCustomPropertyManager(QObject* parent = 0);
...
Q_SIGNALS:
    ...
    void customOpenTriggered(QtProperty *property, QtCustomPropertyManager *thisManager);
    void customPopupTriggered(QtProperty *property, QtCustomPropertyManager *thisManager);
protected:
    virtual void initializeProperty(QtProperty *property);
    virtual void uninitializeProperty(QtProperty *property);
...
private:
    class QtCustomPropertyManagerPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtCustomPropertyManager)
    Q_DISABLE_COPY(QtCustomPropertyManager)
    Q_PRIVATE_SLOT(d_func(), void slotDeliverOpenEvent(QtProperty*));
    Q_PRIVATE_SLOT(d_func(), void slotDeliverPopupEvent(QtProperty*));
};

class  QtButtonPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
protected:
    ...
    virtual void uninitializeProperty(QtProperty *property);
private:
    class QtButtonPropertyManagerPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtButtonPropertyManager)
    Q_DISABLE_COPY(QtButtonPropertyManager)
    Q_PRIVATE_SLOT(d_func(), void slotDeliverClickedEvent(QtProperty*));
};
