...
class QtDoubleSliderFactoryPrivate;

class  QtDoubleSliderFactory : public QtAbstractEditorFactory<QtDoublePropertyManager>
{
    Q_OBJECT
public:
    QtDoubleSliderFactory(QObject *parent = 0);
...
private:
    QtDoubleSliderFactoryPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtDoubleSliderFactory)
    Q_DISABLE_COPY(QtDoubleSliderFactory)
...
class QtPopupEditorFactoryPrivate;

class  QtPopupEditorFactory : public QtAbstractEditorFactory<QtPathPropertyManager>
{
    Q_OBJECT
public:
    QtPopupEditorFactory(QObject *parent = 0);
    ~QtPopupEditorFactory();
protected:
...
private:
    QtPopupEditorFactoryPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtPopupEditorFactory)
    Q_DISABLE_COPY(QtPopupEditorFactory)
    Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, const QString &))
    Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
    Q_PRIVATE_SLOT(d_func(), void slotSetValue(const QString &))
    Q_PRIVATE_SLOT(d_func(), void slotOpenTriggered(class QtPopupEditorWidget*))
    // cjh add: for edit:
    Q_PRIVATE_SLOT(d_func(), void slotEditingFinished())
    //Q_PRIVATE_SLOT(d_func(), void slotRegExpChanged(QtProperty *, const QRegExp &))
};
...
class QtCustomEditorFactoryPrivate;
class QtCustomEditorWidget;

class  QtCustomEditorFactory : public QtAbstractEditorFactory<QtCustomPropertyManager>
{
    Q_OBJECT
public:
    QtCustomEditorFactory(QObject *parent = 0);
    ~QtCustomEditorFactory();
protected:
    void connectPropertyManager(QtCustomPropertyManager *manager);
    QWidget *createEditor(QtCustomPropertyManager *manager, QtProperty *property,
        QWidget *parent);
    void disconnectPropertyManager(QtCustomPropertyManager *manager);
private:
    QtCustomEditorFactoryPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtCustomEditorFactory)
    Q_DISABLE_COPY(QtCustomEditorFactory)
    Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, const QVariant &))
    Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
    Q_PRIVATE_SLOT(d_func(), void slotOpenTriggered(QtCustomEditorWidget* editor))
    Q_PRIVATE_SLOT(d_func(), void slotPopupTriggered(QtCustomEditorWidget* editor));
};

class QtButtonFactoryPrivate;

class  QtButtonFactory : public QtAbstractEditorFactory<QtButtonPropertyManager>
{
    Q_OBJECT
public:
...
protected:
    ...
    QWidget *createEditor(QtButtonPropertyManager *manager, QtProperty *property,
        QWidget *parent);
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
    Q_PRIVATE_SLOT(d_func(), void slotSetValue(const QString &))
    Q_PRIVATE_SLOT(d_func(), void slotButtonClicked(class QtButtonWidget*))
};
