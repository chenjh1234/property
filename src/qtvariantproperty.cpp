...
template<typename T>
struct ConvertQVariantTo : std::unary_function<QVariant const&, T>
{
    T operator ()(QVariant const& v) const {
        return v.value<T>();
    }
};
...
const QString AttrName::minimum     = QLatin1String("minimum");
const QString AttrName::maximum     = QLatin1String("maximum");
const QString AttrName::singleStep  = QLatin1String("singleStep");
const QString AttrName::decimals    = QLatin1String("decimals");
const QString AttrName::regExp      = QLatin1String("regExp");
const QString AttrName::constraint  = QLatin1String("constraint");
const QString AttrName::enumIcons   = QLatin1String("enumIcons");
const QString AttrName::enumNames   = QLatin1String("enumNames");
const QString AttrName::flagNames   = QLatin1String("flagNames");
const QString AttrName::enumValues  = QLatin1String("enumValues");

//====================================================

const int QtVariant::Boolean = QVariant::Bool;
const int QtVariant::Double = QVariant::Double;
const int QtVariant::Color = QVariant::Color;
const int QtVariant::Int = QVariant::Int;
const int QtVariant::String = QVariant::String;
const int QtVariant::Char = QVariant::Char;

const int QtVariant::Rect = QVariant::Rect;
const int QtVariant::RectF = QVariant::RectF;
const int QtVariant::Point = QVariant::Point;
const int QtVariant::PointF = QVariant::PointF;
const int QtVariant::Size = QVariant::Size;
const int QtVariant::SizeF = QVariant::SizeF;

const int QtVariant::Font = QVariant::Font;
const int QtVariant::Locale = QVariant::Locale;
const int QtVariant::Cursor = QVariant::Cursor;
const int QtVariant::KeySequence = QVariant::KeySequence;
const int QtVariant::SizePolicy = QVariant::SizePolicy;
const int QtVariant::DateTime = QVariant::DateTime;
const int QtVariant::Date = QVariant::Date;
const int QtVariant::Time = QVariant::Time;

int QtVariant::sliderDoubleTypeId()
{
    return QtVariantPropertyManager::sliderDoubleTypeId();
}
int QtVariant::enumTypeId()
{
    return QtVariantPropertyManager::enumTypeId();
}
int QtVariant::iconMapTypeId()
{
    return QtVariantPropertyManager::iconMapTypeId();
}
int QtVariant::flagTypeId()
{
    return QtVariantPropertyManager::flagTypeId();
}
int QtVariant::groupTypeId()
{
    return QtVariantPropertyManager::groupTypeId();
}
int QtVariant::groupWithTextTypeId()
{
    return QtVariantPropertyManager::groupWithTextTypeId();
}
int QtVariant::pathTypeId()
{
    return QtVariantPropertyManager::pathTypeId();
}
int QtVariant::customTypeId()
{
    return QtVariantPropertyManager::customTypeId();
}

int QtVariant::buttonTypeId()
{
    return QtVariantPropertyManager::buttonTypeId();
}
int QtVariant::gradientColorTypeId()
{
    return QtVariantPropertyManager::gradientColorTypeId();
}
int QtVariant::colorTemplateTypeId()
{
    return QtVariantPropertyManager::colorTemplateTypeId();
}
int QtVariant::materialTypeId()
{
    return QtVariantPropertyManager::materialTypeId();
}
...
class QtGroupWithTextPropertyType
{
};
...
class QtSliderDoublePropertyType
{
};

class QtCustomPropertyType
{
};

class QtButtonPropertyType
{
};
...
Q_DECLARE_METATYPE(QtGroupWithTextPropertyType)
Q_DECLARE_METATYPE(QtPathPropertyType)
Q_DECLARE_METATYPE(QtSliderDoublePropertyType)
Q_DECLARE_METATYPE(QtCustomPropertyType)
Q_DECLARE_METATYPE(QtButtonPropertyType)
...
int QtVariantPropertyManager::groupWithTextTypeId()
{
    return qMetaTypeId<QtGroupWithTextPropertyType>();
}
...
/*!
    Returns the type id for a gradient color.

    Note that the property's attribute type can be retrieved using the
    attributeType() function.

    \sa attributeType(), valueType()
*/
int QtVariantPropertyManager::gradientColorTypeId()
{
    return enumTypeId();
}

int QtVariantPropertyManager::colorTemplateTypeId()
{
    return pathTypeId();
}

int QtVariantPropertyManager::materialTypeId()
{
    return pathTypeId();
}
...
int QtVariantPropertyManager::sliderDoubleTypeId()
{
    return qMetaTypeId<QtSliderDoublePropertyType>();
}

int QtVariantPropertyManager::customTypeId()
{
    return qMetaTypeId<QtCustomPropertyType>();
}

int QtVariantPropertyManager::buttonTypeId()
{
    return qMetaTypeId<QtButtonPropertyType>();
}
...
public:
    ...
    void slotEnumValuesChanged(QtProperty *property, const QList<int> &values);
    ...
    void slotOpenPathTriggered(QtProperty *property, QtPathPropertyManager *manager);
    void slotCustomOpenTriggered(QtProperty *property, QtCustomPropertyManager *thisManager);
    void slotCustomPopupTriggered(QtProperty *property, QtCustomPropertyManager *thisManager);
    void slotValueChanged(QtProperty* property, QVariant val);
    void slotButtonClicked(QtProperty* property);
    ...
    const QString m_enumValuesAttribute;
...
QtVariantPropertyManagerPrivate::QtVariantPropertyManagerPrivate() :
    ...
    m_enumValuesAttribute(QLatin1String("enumValues")),
            ...
            QtVariantProperty *after, QtProperty *internal)
{
    ...
    varChild->setExpanded(internal->isExpanded());
...
void QtVariantPropertyManagerPrivate::slotOpenPathTriggered(QtProperty *property, QtPathPropertyManager */*manager*/)
{
    if (QtVariantProperty* varProp = m_internalToProperty.value(property, 0))
        emit q_ptr->openPathTriggered(varProp, q_ptr);
}

void QtVariantPropertyManagerPrivate::slotCustomOpenTriggered(QtProperty *property, QtCustomPropertyManager */*thisManager*/)
{
    if (QtVariantProperty* varProp = m_internalToProperty.value(property, 0))
        emit q_ptr->customOpenTriggered(varProp, q_ptr);
}

void QtVariantPropertyManagerPrivate::slotCustomPopupTriggered(QtProperty *property, QtCustomPropertyManager */*thisManager*/)
{
    if (QtVariantProperty* varProp = m_internalToProperty.value(property, 0))
        emit q_ptr->customPopupTriggered(varProp, q_ptr);
}

void QtVariantPropertyManagerPrivate::slotValueChanged(QtProperty *property, QVariant val)
{
    valueChanged(property, val);
}

void QtVariantPropertyManagerPrivate::slotButtonClicked(QtProperty *property)
{
    if (QtVariantProperty* varProp = m_internalToProperty.value(property, 0))
        emit q_ptr->buttonClicked(varProp);
}
...
void QtVariantPropertyManagerPrivate::slotEnumValuesChanged(QtProperty *property, const QList<int> &values)
{
    if (QtVariantProperty *varProp = m_internalToProperty.value(property, 0)) {
        QVariantList varValues;
        std::copy(values.begin(), values.end(), std::back_inserter(varValues));
        emit q_ptr->attributeChanged(varProp, m_enumValuesAttribute, varValues);
    }
}
    ...
    : QtAbstractPropertyManager(parent)
{
    ...
    // QtCustomPropertyManager
    QtCustomPropertyManager *customPropertyManager = new QtCustomPropertyManager(this);
    d_ptr->m_typeToPropertyManager[customTypeId()] = customPropertyManager;
    d_ptr->m_typeToValueType[customTypeId()] = 0;
    connect(customPropertyManager, SIGNAL(valueChanged(QtProperty*,QVariant)),
            this, SLOT(slotValueChanged(QtProperty*,QVariant)));
    connect(customPropertyManager, SIGNAL(customOpenTriggered(QtProperty*,QtCustomPropertyManager*)),
            this, SLOT(slotCustomOpenTriggered(QtProperty *, QtCustomPropertyManager *)));
    connect(customPropertyManager, SIGNAL(customPopupTriggered(QtProperty*,QtCustomPropertyManager*)),
            this, SLOT(slotCustomPopupTriggered(QtProperty *, QtCustomPropertyManager *)));
    ...
    d_ptr->m_typeToAttributeToAttributeType[enumId][d_ptr->m_enumValuesAttribute] = QVariant::List;
    ...
    connect(enumPropertyManager, SIGNAL(enumValuesChanged(QtProperty *, const QList<int> &)),
            this, SLOT(slotEnumValuesChanged(QtProperty *, const QList<int> &)));
    ...
    // GroupPropertyManager
    int groupWithTextId = groupWithTextTypeId();
    QtStringPropertyManager *groupWithTextPropertyManager = new QtStringPropertyManager(this);
    groupWithTextPropertyManager->setProperty("editorType", "noneEditor");
    d_ptr->m_typeToPropertyManager[groupWithTextId] = groupWithTextPropertyManager;
    d_ptr->m_typeToValueType[groupWithTextId] = QVariant::String;
    d_ptr->m_typeToAttributeToAttributeType[groupWithTextId][d_ptr->m_regExpAttribute] = QVariant::RegExp;
    connect(groupWithTextPropertyManager, SIGNAL(valueChanged(QtProperty *, const QString &)),
                this, SLOT(slotValueChanged(QtProperty *, const QString &)));
    connect(groupWithTextPropertyManager, SIGNAL(regExpChanged(QtProperty *, const QRegExp &)),
                this, SLOT(slotRegExpChanged(QtProperty *, const QRegExp &)));
    // PathPropertyManager
    ...
    d_ptr->m_typeToValueType[pathId] = QVariant::String;
    connect(pathPropertyManager, SIGNAL(valueChanged(QtProperty *, const QString &)),
            this, SLOT(slotValueChanged(QtProperty *, const QString &)));
    connect(pathPropertyManager, SIGNAL(openPathTriggered(QtProperty *, QtPathPropertyManager *)),
            this, SLOT(slotOpenPathTriggered(QtProperty *, QtPathPropertyManager *)));
    // ButtonPropertyManager
    int buttonId = buttonTypeId();
    QtButtonPropertyManager* buttonManager = new QtButtonPropertyManager(this);
    d_ptr->m_typeToPropertyManager[buttonId] = buttonManager;
    d_ptr->m_typeToValueType[buttonId] = QVariant::String;
    connect(buttonManager, SIGNAL(valueChanged(QtProperty*,QString)),
            this, SLOT(slotValueChanged(QtProperty *, const QString &)));
    connect(buttonManager, SIGNAL(buttonClicked(QtProperty*)),
            this, SLOT(slotButtonClicked(QtProperty*)));
    // DoublePropertyManager
    int sliderDoubleId = sliderDoubleTypeId();
    QtDoublePropertyManager *sliderDoublePropertyManager = new QtDoublePropertyManager(this);
    sliderDoublePropertyManager->setProperty("editorType", "slider");
    d_ptr->m_typeToPropertyManager[sliderDoubleId] = sliderDoublePropertyManager;
    d_ptr->m_typeToValueType[sliderDoubleId] = QVariant::Double;
    d_ptr->m_typeToAttributeToAttributeType[sliderDoubleId][d_ptr->m_minimumAttribute] = QVariant::Double;
    d_ptr->m_typeToAttributeToAttributeType[sliderDoubleId][d_ptr->m_maximumAttribute] = QVariant::Double;
    d_ptr->m_typeToAttributeToAttributeType[sliderDoubleId][d_ptr->m_singleStepAttribute] = QVariant::Double;
    d_ptr->m_typeToAttributeToAttributeType[sliderDoubleId][d_ptr->m_decimalsAttribute] = QVariant::Double;
    connect(sliderDoublePropertyManager, SIGNAL(valueChanged(QtProperty *, double)),
                this, SLOT(slotValueChanged(QtProperty *, double)));
    connect(sliderDoublePropertyManager, SIGNAL(rangeChanged(QtProperty *, double, double)),
                this, SLOT(slotRangeChanged(QtProperty *, double, double)));
    connect(sliderDoublePropertyManager, SIGNAL(singleStepChanged(QtProperty *, double)),
                this, SLOT(slotSingleStepChanged(QtProperty *, double)));
    connect(sliderDoublePropertyManager, SIGNAL(decimalsChanged(QtProperty *, int)),
                this, SLOT(slotDecimalsChanged(QtProperty *, int)));
}
...
QVariant QtVariantPropertyManager::value(const QtProperty *property) const
{
    ...
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
    ...
    } else if (QtCustomPropertyManager *customManager = qobject_cast<QtCustomPropertyManager*>(manager)) {
        return customManager->value(internProp);
        ...
        return buttonManager->value(internProp);
    }
    return QVariant();
}
...
QVariant QtVariantPropertyManager::attributeValue(const QtProperty *property, const QString &attribute) const
{
    ...
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
        ...
        if (attribute == d_ptr->m_enumValuesAttribute) {
            QVariantList varEnumValues;
            const QList<int> enumValues = enumManager->enumValues(internProp);
            std::copy(enumValues.begin(), enumValues.end(), std::back_inserter(varEnumValues));
            return varEnumValues;
        }
        return QVariant();
    } else if (QtFlagPropertyManager *flagManager = qobject_cast<QtFlagPropertyManager *>(manager)) {
...
void QtVariantPropertyManager::setValue(QtProperty *property, const QVariant &val)
{
    ...
    if (valType == 0 && internProp->hasCustomValue())
        /* is ok*/;
    else if (propType != valType && !val.canConvert(static_cast<QVariant::Type>(valType)))
        return;
    ...
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
        ...
        customManager->setValue(internProp, val);
        return;
    } else if (QtStringPropertyManager *stringManager = qobject_cast<QtStringPropertyManager *>(manager)) {
        ...
        buttonManager->setValue(internProp, val.value<QString>());
        return;
    }
}
        ...
        const QString &attribute, const QVariant &value)
{
    ...
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
        ...
        else if (attribute == d_ptr->m_decimalsAttribute)
        ...
        else if (attribute == d_ptr->m_enumIconsAttribute)
            enumManager->setEnumIcons(internProp, value.value<QtIconMap>());
        else if (attribute == d_ptr->m_enumValuesAttribute) {
            QList<int> enumValues;
            const QVariantList varEnumValues = value.value<QVariantList>();
            std::transform(varEnumValues.begin(), varEnumValues.end(), std::back_inserter(enumValues), ConvertQVariantTo<int>());
            enumManager->setEnumValues(internProp, enumValues);
        }
        return;
    } else if (QtFlagPropertyManager *flagManager = qobject_cast<QtFlagPropertyManager *>(manager)) {
        if (attribute == d_ptr->m_flagNamesAttribute)
...
void QtVariantPropertyManager::initializeProperty(QtProperty *property)
{
    ...
    if (it != d_ptr->m_typeToPropertyManager.constEnd()) {
        ...
        if (!d_ptr->m_creatingSubProperties) {
            ...
            varProp->setExpanded(internProp->isExpanded());
...
bool QtVariantPropertyManager::hasCustomValue(const QtProperty *property) const
{
    QtProperty *internProp = propertyToWrappedProperty()->value(property, 0);
    if (internProp == 0)
        return false;

    return internProp->hasCustomValue();
}

QVariant QtVariantPropertyManager::customValue(const QtProperty *property) const
{
    QtProperty *internProp = propertyToWrappedProperty()->value(property, 0);
    if (internProp == 0)
        return QVariant();

    return internProp->customValue();
}
...
public:
    ...
    QtPopupEditorFactory       *m_popupEditorFactory;
    QtDoubleSliderFactory       *m_doubleSliderFactory;
    QtCustomEditorFactory      *m_customEditorFactory;
    ...
    : QtAbstractEditorFactory<QtVariantPropertyManager>(parent)
{
    ...
    d_ptr->m_popupEditorFactory = new QtPopupEditorFactory(this);
    const int pathId = QtVariantPropertyManager::pathTypeId();
    d_ptr->m_factoryToType[d_ptr->m_popupEditorFactory] = pathId;
    d_ptr->m_typeToFactory[pathId] = d_ptr->m_popupEditorFactory;

    d_ptr->m_doubleSliderFactory = new QtDoubleSliderFactory(this);
    const int sliderDoubleId = QtVariantPropertyManager::sliderDoubleTypeId();
    d_ptr->m_factoryToType[d_ptr->m_doubleSliderFactory] = sliderDoubleId;
    d_ptr->m_typeToFactory[sliderDoubleId] = d_ptr->m_doubleSliderFactory;

    d_ptr->m_customEditorFactory = new QtCustomEditorFactory(this);
    const int customId = QtVariantPropertyManager::customTypeId();
    d_ptr->m_factoryToType[d_ptr->m_customEditorFactory] = customId;
    d_ptr->m_typeToFactory[customId] = d_ptr->m_customEditorFactory;

    d_ptr->m_buttonFactory = new QtButtonFactory(this);
    const int buttonId = QtVariantPropertyManager::buttonTypeId();
    d_ptr->m_factoryToType[d_ptr->m_buttonFactory] = buttonId;
    d_ptr->m_typeToFactory[buttonId] = d_ptr->m_buttonFactory;
}
...
void QtVariantEditorFactory::connectPropertyManager(QtVariantPropertyManager *manager)
{
    ...
    while (itDouble.hasNext()) {
        QtDoublePropertyManager* manager = itDouble.next();
        if (manager->property("editorType") == "slider")
            d_ptr->m_doubleSliderFactory->addPropertyManager(manager);
        else
    ...
    QList<QtCustomPropertyManager*> customPropertyManagers = qFindChildren<QtCustomPropertyManager*>(manager);
    QListIterator<QtCustomPropertyManager*> itCustom(customPropertyManagers);
    while (itCustom.hasNext())
        d_ptr->m_customEditorFactory->addPropertyManager(itCustom.next());
    ...
    while (itString.hasNext()) {
        QtStringPropertyManager* manager = itString.next();
        if (manager->property("editorType") != "noneEditor")
    ...
    QList<QtPathPropertyManager*> pathPropertyManagers = qFindChildren<QtPathPropertyManager*>(manager);
    QListIterator<QtPathPropertyManager*> itPath(pathPropertyManagers);
    while (itPath.hasNext())
        d_ptr->m_popupEditorFactory->addPropertyManager(itPath.next());

    QList<QtButtonPropertyManager*> buttonManager = qFindChildren<QtButtonPropertyManager*>(manager);
    QListIterator<QtButtonPropertyManager*> itButton(buttonManager);
...
void QtVariantEditorFactory::disconnectPropertyManager(QtVariantPropertyManager *manager)
{
    ...
    while (itDouble.hasNext()) {
        QtDoublePropertyManager* manager = itDouble.next();
        if (manager->property("editorType") == "slider")
            d_ptr->m_doubleSliderFactory->removePropertyManager(manager);
        else
    ...
    QListIterator<QtCustomPropertyManager*> itCustom(customPropertyManagers);
    while (itCustom.hasNext())
        d_ptr->m_customEditorFactory->removePropertyManager(itCustom.next());
    ...
    QListIterator<QtPathPropertyManager*> itPath(pathPropertyManagers);
    while (itPath.hasNext())
        d_ptr->m_popupEditorFactory->removePropertyManager(itPath.next());

    QList<QtButtonPropertyManager*> buttonManager = qFindChildren<QtButtonPropertyManager*>(manager);
    QListIterator<QtButtonPropertyManager*> itButton(buttonManager);
    while (itButton.hasNext())
        d_ptr->m_buttonFactory->removePropertyManager(itButton.next());
}
